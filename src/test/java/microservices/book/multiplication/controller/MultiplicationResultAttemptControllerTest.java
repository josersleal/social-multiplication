...
public class MultiplicationResultAttemptControllerTest {
	...
	public void postResultReturnCorrect() throws Exception {
		genericParametrizedTests(true);
	}

	@Test
	public void postResultNotReturnCorrect() throws Exception {
		genericParametrizedTests(false);
	}

	private void genericParametrizedTests(final boolean correct) throws Exception {
